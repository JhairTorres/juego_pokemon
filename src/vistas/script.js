...
formUsuario.addEventListener('submit', async (event) => {
    ...
    try {
        const response = await fetch('http://localhost:3007/api/usuario/registrar', {
            method: 'POST',
            headers: {
...
formPokemon.addEventListener('submit', async (event) => {
    ...
    try {
        const response = await fetch('http://localhost:3007/api/pokemon/registrar', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function capturarPokemon(pokemonId) {
    ...
    try {
        const response = await fetch('http://localhost:3005/api/captura/capturar', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function actualizarTablaCapturas() {
    try {
        const response = await fetch('http://localhost:3005/api/captura/listar');  // Suponiendo que la API devuelva las capturas
...
async function obtenerPokemones() {
    try {
      const response = await fetch('http://localhost:3007/api/pokemon/listar');
  ...
  async function obtenerCapturas() {
    try {
        const response = await fetch('http://localhost:3007/api/captura/listar');
        const data = await response.json();
